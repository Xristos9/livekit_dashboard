...
export function getS3Client() {
  ...
  if (!cfg.key || !cfg.secret || !cfg.bucket) {
    throw new Error(
      'Missing required DigitalOcean Spaces configuration. Please set NUXT_DO_SPACES_KEY, NUXT_DO_SPACES_SECRET, and NUXT_DO_SPACES_BUCKET environment variables.'
    )
  }
